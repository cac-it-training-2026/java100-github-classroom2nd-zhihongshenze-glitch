	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 5; i++) {
			if (ABKosanArray1[i] % 2 == 0) {
				evenArray[evenCount] = ABKosanArray1[i];
				evenCount++;
			} else {
				oddArray[oddCount] = ABKosanArray1[i];
				oddCount++;
			}
		}
		...
		for (int i = 0; i < 5; i++) {
			if (ABKosanArray2[i] % 2 == 0) {
				evenArray[evenCount] = ABKosanArray2[i];
				evenCount++;
			} else {
				oddArray[oddCount] = ABKosanArray2[i];
				oddCount++;
			}
		}

		ABKosanArray1 = oddArray;
		ABKosanArray2 = evenArray;
